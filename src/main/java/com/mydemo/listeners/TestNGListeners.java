package com.mydemo.listeners;

import com.mydemo.drivers.AppiumDriverProvider;
import com.mydemo.drivers.UITest;
import com.mydemo.media.ScreenshotsManager;
import com.mydemo.server.AppiumServerManager;
import com.mydemo.utils.FileUtils;
import com.mydemo.utils.dataReader.PropertyReader;
import com.mydemo.utils.logs.LogsManager;
import com.mydemo.utils.report.AllureAttachmentManager;
import com.mydemo.utils.report.AllureConstants;
import com.mydemo.utils.report.AllureEnvironmentManager;
import com.mydemo.utils.report.AllureReportGenerator;
import com.mydemo.validations.SoftAssertion;
...
public class TestNGListeners implements ISuiteListener, IExecutionListener, IInvokedMethodListener, ITestListener {
    ...
    public void onStart(ISuite suite) {
        suite.getXmlSuite().setName("Framework Test Suite");
        LogsManager.info("════════════════════════════════════════════════════");
